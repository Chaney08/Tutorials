...
public class Main {
        ...
        public static void main(String[] args) {
            ...
            System.out.println("Sequential Stream Count?= " + eList.stream().filter(e -> e.getEmployeeSalary() > 15000).count());
            ...
            t1 = System.currentTimeMillis();
            System.out.println("Parallel Stream Count?= " + eList.parallelStream().filter(e -> e.getEmployeeSalary() > 15000).count());
